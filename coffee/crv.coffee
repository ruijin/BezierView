...
det4 = (x11,  x12,  x13,  x14, \
        x21,  x22,  x23,  x24, \
        x31,  x32,  x33,  x34, \
        x41,  x42,  x43,  x44) ->
    t0 = x11*x22*x33*x44-x11*x22*x34*x43-
...
det3 = (x11,  x12,  x13,  \
        x21,  x22,  x23,  \
        x31,  x32,  x33) ->
    t0 = x11*x22*x33-x11*x23*x32-x12*x21*x33+x12*x23*x31+
        x13*x21*x32-x13*x22*x31
    return t0


krv = (v00, Deriv, crv_result) ->
    x = v00.x; y = v00.y
    z = v00.z; d = v00.w
...
crv4 = (v00, v01,v02, v10, v20, v11, degu, degv, crv_result) ->
    #VEC         Deriv[3][3]
    Deriv = new Array(3)
...
crv3 = (v00, v10, v20, v01, v02, v11,deg, crv_result) ->
    Deriv = new Array(3)
    d1 = deg-1
...
color_array = (v1,v2,v3,v4,crv_array) ->
